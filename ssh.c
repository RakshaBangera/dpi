...
int check_ssh(unsigned char *p_current, unsigned int payload_len, 
               ...
               unsigned short smaller_port)
{
     ...
     if ( payload == NULL) {
         ...
         if (debug_verbose) {
             ...
             printf("Matching signature for SSH...\n");
