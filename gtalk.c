...
int check_gtalk(unsigned char *p_current, unsigned int payload_len, 
               ...
               unsigned short smaller_port)
{
     regex_t regex;
     NODE p_tuple = NULL;
     const char *pattern = "^(<stream:stream.*xmlns=\"jabber:client\">)";
     ...
     if ( payload == NULL) {
         ...
         if (debug_verbose) {
             ...
             printf("Matching signature for GTALK...\n");
